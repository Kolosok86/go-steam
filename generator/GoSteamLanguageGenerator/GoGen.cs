...
namespace GoSteamLanguageGenerator
{
    public class GoGen
    {
        ...
        public void EmitClasses(dynamic root, StringBuilder sb)
        {
            ...
            sb.AppendLine("    \"github.com/kolosok86/go-steam/steamid\"");
            sb.AppendLine("    \"github.com/kolosok86/go-steam/rwu\"");
            sb.AppendLine("    \"github.com/kolosok86/go-steam/protocol/protobuf\"");
            sb.AppendLine(")");
            sb.AppendLine();
