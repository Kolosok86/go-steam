...
const file_cstrike15_gcmessages_proto_rawDesc = "" +
	...
	"\x1cquest_normal_points_required\x18\x04 \x01(\x05R\x19questNormalPointsRequired\x12&\n" +
	"\x0fquest_reward_xp\x18\x05 \x01(\x05R\rquestRewardXp\x12!\n" +
	...
	"\x10match_info_teams\x18\x03 \x03(\tR\x0ematchInfoTeams\"\xef\a\n" +
	...
	"serverinfo\x12N\n" +
	"\x14match_end_quest_data\x18\x04 \x01(\v2\x1d.CMsgGC_ServerQuestUpdateDataR\x11matchEndQuestData\"\xed\a\n" +
	...
	"\tkeychains\x18\x14 \x03(\v2\".CEconItemPreviewDataBlock.StickerR\tkeychains\x1a\xad\x02\n" +
	"\aSticker\x12\x12\n" +
